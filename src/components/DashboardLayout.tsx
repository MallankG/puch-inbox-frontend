...
import { fetchSubscriptions } from "@/lib/fetchSubscriptions";
  ...
  return (
    <SubscriptionsProvider>
      <div className="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white h-screen w-screen overflow-hidden flex">
        ...
        {/* Main Content */}
        <div
          className={`flex flex-col ml-${sidebarCollapsed ? '16' : '64'} transition-all duration-300 flex-1 min-h-0 h-full overflow-hidden`}
